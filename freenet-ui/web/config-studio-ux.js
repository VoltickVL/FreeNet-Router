(() => {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      .cs-version{appearance:none;border:1px solid #4a80c3;background:linear-gradient(180deg,#194f91,#123e75);color:#eef6ff;border-radius:9px;padding:7px 10px;font:inherit;font-size:11px;font-weight:800;cursor:pointer}.cs-version:hover{border-color:#72a8ff;background:linear-gradient(180deg,#2467ba,#184c8e);color:#fff}.cs-service-actions{display:flex;gap:8px;align-items:center;flex-wrap:wrap}.cs-service-btn{appearance:none;border:1px solid #4a80c3;background:linear-gradient(180deg,#194f91,#123e75);color:#eef6ff;border-radius:9px;padding:8px 11px;font:inherit;font-size:11px;font-weight:800;cursor:pointer}.cs-service-btn:hover:not(:disabled){border-color:#72a8ff;background:linear-gradient(180deg,#2467ba,#184c8e)}.cs-service-btn:disabled{opacity:.45;cursor:not-allowed}
      ...
      .cs-toolbar{padding-top:2px}.cs-btn{font-size:11px;border-color:#4a80c3!important;background:linear-gradient(180deg,#194f91,#123e75)!important;color:#eef6ff!important}.cs-btn:hover:not(:disabled){border-color:#72a8ff!important;background:linear-gradient(180deg,#2467ba,#184c8e)!important}.cs-btn.primary{min-width:110px;background:linear-gradient(180deg,#347eff,#2367e7)!important;border-color:#69a0ff!important}.cs-list-view .cs-toolbar{display:none!important}.cs-list-view .cs-meta{margin-top:-3px}
