;(() => {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .fn3-journal-head{display:flex;align-items:center;justify-content:space-between;margin-bottom:10px}.fn3-link{border:0;background:transparent;color:#9dc7f2;font-size:12px;cursor:pointer}.fn3-table{width:100%;border-collapse:collapse;font-size:12.5px;line-height:1.42}.fn3-table th{text-align:left;padding:9px 10px;background:#123655;color:#b9cce0;font-size:11.5px;font-weight:800}.fn3-table td{padding:9px 10px;border-top:1px solid #254765;color:#d8e4ef;vertical-align:top}.fn3-table td:first-child{white-space:nowrap;color:#a9bfd6}.fn3-table td:nth-child(2){font-weight:720;color:#c8d8e8}.fn3-result{display:inline-flex;align-items:center;gap:6px;color:#52e4a8;font-weight:760}.fn3-result.neutral{color:#c4d0dc}.fn3-dot{width:7px;height:7px;border-radius:50%;background:currentColor}
      ...
      .fn3-journal-page .fn3-card{margin-top:14px;padding:18px 16px}.fn3-journal-page h1{font-size:30px;margin:0}.fn3-journal-page p{color:#8fa6c0;margin:5px 0 0;font-size:13px}.fn3-journal-page .fn3-table{margin-top:12px;font-size:12.5px}
