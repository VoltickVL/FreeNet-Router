...
TARGET = Path("freenet-ui/web/operation-coordinator.js")
MARKER = "// Issue #347: approved Overview render contract."
source = TARGET.read_text(encoding="utf-8")
if MARKER in source:
    raise SystemExit("issue 347 contract already present")
...
TARGET.write_text(source + overlay, encoding="utf-8")

Path("freenet-ui/overview_issue347_render_contract_test.go").write_text(r'''package main
...
for disposable in (
    Path(".github/workflows/issue-347-codemod.yml"),
    Path(".github/workflows/issue-347-codemod-v2.yml"),
    Path("scripts/issue347_codemod.py"),
):
